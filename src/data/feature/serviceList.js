export default [
  {
    ...
    description:
      "Build your webapp with the world's most popular front-end component library along with Mysite's 32 sets of carefully designed elements."
  },
  {
    media: { icon: ['fab', 'node-js'], color: 'success', className: 'fs-5' },
    title: 'SCSS & Javascript files',
    description:
      'With your purchased copy of Mysite, you will get all the uncompressed & documented SCSS and Javascript source code files.'
  },
  {
