...
import imageMember1 from '../../assets/img/team/1.png';
import imageMember2 from '../../assets/img/team/2.png';
import imageMember3 from '../../assets/img/team/3.png';

const autoCompleteInitialItem = [
  { url: `/social/events`, breadCrumbTexts: ['Pages ', ' Events'], catagories: 'recentlyBrowsedItems' },
  {
