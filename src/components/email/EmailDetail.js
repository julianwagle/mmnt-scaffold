      ...
      <Card>
            ...
            <Col lg={8} className="col-xxl-6">
              <Card className="shadow-none mb-3">
                ...
                <CardBody>
                  ...
                  <p>
                    On International Women’s Day, we at Mysite want you to discover the skills you can learn from
        ...
        <CardFooter>
          <Row className="justify-content-between">
            <Col>
              <ButtonIcon icon="reply" size="sm" className="mr-2" color="mysite-default">
                Reply
              </ButtonIcon>
              <ButtonIcon icon="location-arrow" size="sm" color="mysite-default">
                Forward
              </ButtonIcon>
            </Col>
