...
const Backgrounds = () => (
  <Fragment>
    ...
    />
    <Card className="mb-3">
      <CustomCardHeader title="Image Background" light={false} />
      <CardBody className="bg-light">
        <CustomEditor code={imageCode} scope={{ Background, gallery2 }} language="jsx" />
      </CardBody>
    </Card>
    <Card>
      <CustomCardHeader title="Image Background" light={false} />
      <CardBody className="bg-light">
        <CustomEditor code={videoCode} scope={{ Background, beachMp4, beachWebm, beachImage }} language="jsx" />
      </CardBody>
    </Card>
  </Fragment>
);
