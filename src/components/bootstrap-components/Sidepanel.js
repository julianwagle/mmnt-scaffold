...
const Sidepanel = () => {
  ...
  return (
    <Fragment>
      <PageHeader
        title="Sidepanel"
        description="You can show lists, forms, notifications, or other custom contents into the Mysite Sidepanel."
        className="mb-3"
      >
        <Button
          tag="a"
      ...
      <Card className="mb-3">
        ...
        <CardBody className="bg-light">
          <p>
            Mysite Sidepanel uses Boostrap Modal features to show the panel content. <code>.modal-fixed-right</code> and
