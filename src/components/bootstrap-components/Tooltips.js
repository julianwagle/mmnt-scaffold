...
const Tooltips = () => {
  return (
    <Fragment>
      <PageHeader
        title="Tooltips"
        description="Documentation and examples for adding Mysite tooltips with CSS and JavaScript using CSS3 for animations and data-attributes for local title storage."
        className="mb-3"
      >
        <Button
          tag="a"
      ...
      <Card className="mb-3">
        ...
        <CardBody className="bg-light">
          <CustomEditor code={tooltipsExampleCode} language="jsx" />
        </CardBody>
      </Card>
      <Card>
