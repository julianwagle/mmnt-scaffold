...
const SpinnersExample = () => {
  ...
  return (
    <Fragment>
      <PageHeader
        ...
        description="Here is the available built-in option of Mysite's powerful, responsive vertical navigation. The following sections describe how you can customize both the responsive breakpoint and collapsing behavior."
        className="mb-3"
      />
      <Card className="mb-3">
        <CustomCardHeader title="Responsive behavior" light={false} />
        <CardBody className="bg-light">
          Mysite used the reactstrap's <code>expand</code> property in <code>Navbar</code> component to decide when the
      ...
      <Card className="mb-3">
        <CustomCardHeader title="Collapsing behavior" light={false} />
        <CardBody className="bg-light">
          You can control the default collapsing behavior of Mysite's vertical navigation - whether it will show up with
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line
      ...
      <Card className="mb-3">
        <CustomCardHeader title="JSX" light={false} />
        <CardBody className="bg-light">
      ...
      <Card className="mb-3">
        <CustomCardHeader title="SCSS" light={false} />
        <CardBody className="bg-light">
          Mysite allow you to customize your Navbar vibrant with SCSS variables. The available options are listed below:
