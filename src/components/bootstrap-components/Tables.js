...
const Tables = () => {
  return (
    <Fragment>
      <PageHeader
        title="Tables"
        description="Documentation and examples for opt-in styling of tables with Mysite."
        className="mb-3"
      >
        <Button
          tag="a"
      ...
      <Row noGutters>
        ...
        <Col sm={6} className="pl-sm-2 mb-3">
          <Card>
            ...
            <CardBody className="bg-light">
              <CustomEditor code={darkExampleCode} />
            </CardBody>
          </Card>
        </Col>
      </Row>
      <Card className="mb-3">
        <CustomCardHeader title="Property" light={false} />
        <CardBody className="bg-light">
          <CustomEditor code={propertyCode} hidePreview />
        </CardBody>
      </Card>
      <Row noGutters>
        <Col sm={6} className="pr-sm-2 mb-3">
          <Card>
            ...
            <CardBody className="bg-light">
              <CustomEditor code={headerDarkCode} />
            </CardBody>
          </Card>
        </Col>
        <Col sm={6} className="pl-sm-2 mb-3">
          <Card>
            ...
            <CardBody className="bg-light">
              <CustomEditor code={headerLightCode} />
            </CardBody>
          </Card>
        </Col>
        <Col sm={6} className="pr-sm-2 mb-3">
          <Card>
            ...
            <CardBody className="bg-light">
              <CustomEditor code={tableStripedCode} />
            </CardBody>
          </Card>
        </Col>
        <Col sm={6} className="pl-sm-2 mb-3">
          <Card>
            ...
            <CardBody className="bg-light">
              <CustomEditor code={tableHoverCode} />
            </CardBody>
          </Card>
        </Col>
      </Row>
