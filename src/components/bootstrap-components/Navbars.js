...
const Navbars = () => {
  return (
    <Fragment>
      ...
      <Card className="mb-3">
        <CustomCardHeader title="Navbar Dark" light={false} />
        <CardBody className="bg-light">
          <CustomEditor code={navbarDarkCode} />
        </CardBody>
      </Card>
      <Card className="mb-3">
        <CustomCardHeader title="Navbar Primary" light={false} />
        <CardBody className="bg-light">
          <CustomEditor code={navbarPrimaryCode} />
        </CardBody>
      </Card>
      <Card className="mb-3">
        <CustomCardHeader title="Navbar Properties" light={false} />
        <CardBody className="bg-light">
          <CustomEditor code={propertiesNavbar} hidePreview />
        </CardBody>
      </Card>
      <Card className="mb-3">
        <CustomCardHeader title="NavbarBrand Properties" light={false} />
        <CardBody className="bg-light">
          <CustomEditor code={propertiesNavbarCode} hidePreview />
        </CardBody>
      </Card>
      <Card className="mb-3">
        <CustomCardHeader title="Navbar Toggler" light={false} />
        <CardBody className="bg-light">
          <CustomEditor code={navbarTogglerCode} language="jsx" />
        </CardBody>
      </Card>
      <Card>
        <CustomCardHeader title="NavbarToggler Properties" light={false} />
        <CardBody className="bg-light">
          <CustomEditor code={propertiesNavbarTogglerCode} hidePreview />
        </CardBody>
      </Card>
    </Fragment>
  );
