...
const dropdownCode = `function dropdownExample() {
  ...
  return (
    <Dropdown isOpen={isOpen} toggle={() => setIsOpen(!isOpen)}>
      <DropdownToggle caret className="btn btn-mysite-default">
        Dropdown button
      </DropdownToggle>
      <DropdownMenu>
...
const dropdownAlignmentExample = `function dropdownAlignmentExample() {
  ...
  return (
    <Dropdown isOpen={dropdownOpen} toggle={() => setDropdownOpen(!dropdownOpen)}>
      <DropdownToggle className="btn btn-mysite-default" caret>
  ...
  return (
    <Fragment>
      <Dropdown group isOpen={isOpenOne} toggle={() => setIsOpenOne(!isOpenOne)}>
        <DropdownToggle caret size="lg" className="btn btn-mysite-default mb-2">
          Dropdown
        </DropdownToggle>
        <DropdownMenu>
          <DropdownItem header>Header</DropdownItem>
      ...
      <Dropdown isOpen={isOpenTwo} toggle={() => setIsOpenTwo(!isOpenTwo)}>
        <DropdownToggle caret className="btn btn-mysite-default mb-2">
          Dropdown
        </DropdownToggle>
        <DropdownMenu>
          <DropdownItem header>Header</DropdownItem>
      ...
      <Dropdown isOpen={isOpenThree} toggle={() => setIsOpenThree(!isOpenThree)}>
        <DropdownToggle caret size="sm" className="btn btn-mysite-default">
          Dropdown
        </DropdownToggle>
        <DropdownMenu>
          <DropdownItem header>Header</DropdownItem>
  ...
  return (
    <Flex justify="between">
      ...
      <Dropdown direction="up" isOpen={isOpenUp} toggle={() => setIsOpenUp(!isOpenUp)}>
        <DropdownToggle caret className="btn btn-mysite-default mr-2">
          Dropup
        </DropdownToggle>
        <DropdownMenu>
          <DropdownItem header>Header</DropdownItem>
...
const Dropdowns = () => (
  <Fragment>
    <PageHeader
      title="Dropdown"
      description="Toggle contextual overlays for displaying lists of links and more with the Mysite dropdown plugin."
      className="mb-3"
    >
      <Button
        tag="a"
    ...
    <Card className="mb-3">
      ...
      <CardBody className="bg-light">
        <CustomEditor code={dropdownCode} language="jsx" />
      </CardBody>
    </Card>
    <Card className="mb-3">
      <CardBody>
        <CustomEditor code={dropdownProperties} hidePreview />
        <CustomEditor code={dropdownToggleProperties} hidePreview />
        <CustomEditor code={dropdownMenuProperties} hidePreview />
        <CustomEditor code={dropdownItemProperties} hidePreview />
      </CardBody>
    </Card>
    <Card className="mb-3">
      <CustomCardHeader title="Uncontrolled Dropdown" light={false} />
      <CardBody className="bg-light">
        <CustomEditor code={dropdownUncontrolledCode} language="jsx" />
      </CardBody>
    </Card>
    <Card className="mb-3">
      <CustomCardHeader title="Alignment" light={false} />
      <CardBody className="bg-light">
        <CustomEditor code={dropdownAlignmentExample} language="jsx" />
      </CardBody>
    </Card>
    <Card className="mb-3">
      <CustomCardHeader title="Sizing" light={false} />
      <CardBody className="bg-light">
        <CustomEditor code={dropdownSizingCode} language="jsx" />
      </CardBody>
    </Card>
    <Card>
      <CustomCardHeader title="Direction" light={false} />
      <CardBody className="bg-light">
        <CustomEditor code={dropdownDirectionCode} scope={{ Flex }} language="jsx" />
      </CardBody>
    </Card>
  </Fragment>
);
