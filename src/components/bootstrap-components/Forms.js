...
const propertiesInput = `Input.propTypes = {
  ...
  // type can be things like text, (typical input types) as well as select and textarea, providing children as you normally would to those.
...
const Forms = () => (
  <Fragment>
    ...
    <Card className="mb-3">
      <CustomCardHeader title="Basic Form" light={false} />
      <CardBody className="bg-light">
        <CustomEditor code={basicFormCode} />
      </CardBody>
    </Card>
    <Card className="mb-3">
      <CustomCardHeader title="Properties" light={false} />
      <CardBody className="bg-light">
        <CustomEditor code={propertiesInput} hidePreview />
        <CustomEditor code={propertiesCustomInput} hidePreview />
        <CustomEditor code={propertiesForm} hidePreview />
        <CustomEditor code={propertiesFormFeedback} hidePreview />
        <CustomEditor code={propertiesFormGroup} hidePreview />
        <CustomEditor code={propertiesFormGroup} hidePreview />
        <CustomEditor code={propertiesFormText} hidePreview />
      </CardBody>
    </Card>
    <Card className="mb-3">
      <CustomCardHeader title="Input Group Properties" light={false} />
      <CardBody className="bg-light">
    ...
    <Card className="mb-3">
      <CustomCardHeader title="Input Group" light={false} />
      <CardBody className="bg-light">
        <CustomEditor code={inputGroupCode} language="jsx" />
      </CardBody>
    </Card>
    <PageHeader
      title="Custom Forms"
    ...
    <Row noGutters className="mb-3">
      <Col lg={6} className="pr-lg-2 mb-3">
        <Card className="h-100 mb-2">
          <CustomCardHeader title="Checkboxes" light={false} />
          <CardBody className="bg-light">
            <CustomEditor code={customCheckboxCode} language="jsx" />
          </CardBody>
        </Card>
      </Col>
      <Col lg={6} className="pl-lg-2 mb-3">
        <Card className="h-100">
          <CustomCardHeader title="Radios" light={false} />
          <CardBody className="bg-light">
            <CustomEditor code={customRadioCode} language="jsx" />
          </CardBody>
        </Card>
      </Col>
      <Col lg={6} className="pr-lg-2 mb-3">
        <Card className="h-100">
          <CustomCardHeader title="Inline Radios" light={false} />
          <CardBody className="bg-light">
            <CustomEditor code={InlineRadioCode} scope={{ Flex }} />
          </CardBody>
        </Card>
      </Col>
      <Col lg={6} className="pl-lg-2 mb-3">
        <Card className="h-100">
          <CustomCardHeader title="Disabled" light={false} />
          <CardBody className="bg-light">
            <CustomEditor code={disabledInputFieldsCode} language="jsx" />
          </CardBody>
        </Card>
      </Col>
      <Col lg={6} className="pr-lg-2 mb-3">
        <Card className="h-100">
          <CustomCardHeader title="Switches" light={false} />
          <CardBody className="bg-light">
            <CustomEditor code={customSwitchCode} />
          </CardBody>
        </Card>
      </Col>
      <Col lg={6} className="pl-lg-2 mb-3">
        <Card className="h-100">
          <CustomCardHeader title="Disabled Switches" light={false} />
          <CardBody className="bg-light">
            <CustomEditor code={customSwitchDisabledCode} language="jsx" />
          </CardBody>
        </Card>
      </Col>
      <Col lg={6} className="pr-lg-2">
        <Card className="h-100">
          <CustomCardHeader title="Custom Select" light={false} />
          <CardBody className="bg-light">
            <CustomEditor code={customSelectCode} language="jsx" />
          </CardBody>
        </Card>
      </Col>
      <Col lg={6} className="pl-lg-2">
        <Card className="mb-3">
          <CustomCardHeader title="Multiple Select" light={false} />
          <CardBody className="bg-light">
            <CustomEditor code={multipleSelectCode} language="jsx" />
          </CardBody>
        </Card>
        <Card className="">
          <CustomCardHeader title="File Browser" light={false} />
          <CardBody className="bg-light">
            <CustomEditor code={fileBrowserCode} language="jsx" />
          </CardBody>
        </Card>
      </Col>
    </Row>
