...
const CookieNotice = () => {
  ...
  return (
    <Fragment>
      <PageHeader
        title="Cookie Notice"
        description="Mysite has a built-in notification component that allows users to notify cookie uses on the website."
        className="mb-3"
      >
        <Button
          tag="a"
      ...
      <Card className="mb-3">
        <CustomCardHeader title="Structure" light={false} />
        <CardBody className="bg-light">
          <p>
            Mysite's Cookie Notice uses Reactstrap's "Alerts" feature to show the notice content. <code>visible</code>{' '}
      ...
      <Card className="mb-3">
        <CustomCardHeader title="Options" light={false} />
        <CardBody className="bg-light">
          <p>
            {' '}
