...
import generic1 from '../../assets/img/generic/1.png';
import generic3 from '../../assets/img/generic/3.png';
import generic6 from '../../assets/img/generic/6.png';
import generic7 from '../../assets/img/generic/7.png';
import generic8 from '../../assets/img/generic/8.png';
import generic10 from '../../assets/img/generic/10.png';
import generic11 from '../../assets/img/generic/11.png';
import generic12 from '../../assets/img/generic/12.png';
...
const Cards = () => (
  <Fragment>
    <PageHeader
      title="Cards"
      description="Mysite’s cards provide a flexible and extensible content container with multiple variants and options."
      className="mb-3"
    >
      <Button
        tag="a"
      ...
      <Col xl={6} className="pr-xl-2">
        <Card className="mb-3">
          ...
          <CardBody className="bg-light">
            <CustomEditor code={basicExampleCode} scope={{ generic1 }} language="jsx" />
          </CardBody>
        </Card>
      </Col>
      <Col xl={6} className="pl-xl-2">
        <Card className="mb-3">
          <CustomCardHeader title="Card with list" light={false} />
          <CardBody className="bg-light">
            <CustomEditor code={cardWithListCode} />
          </CardBody>
        </Card>
      </Col>
    </Row>
    <Card className="mb-3">
      ...
      <CardBody className="bg-light">
        <CustomEditor code={propertiesCard} hidePreview />
        <CustomEditor code={propertiesCardBody} hidePreview />
        <CustomEditor code={propertiesCardColumns} hidePreview />
        <CustomEditor code={propertiesCardDeck} hidePreview />
        <CustomEditor code={propertiesCardFooter} hidePreview />
        <CustomEditor code={propertiesCardGroup} hidePreview />
        <CustomEditor code={propertiesCardHeader} hidePreview />
        <CustomEditor code={propertiesCardImg} hidePreview />
        <CustomEditor code={propertiesCardImgOverlay} hidePreview />
        <CustomEditor code={propertiesCardLink} hidePreview />
        <CustomEditor code={propertiesCardSubtitle} hidePreview />
        <CustomEditor code={propertiesCardText} hidePreview />
        <CustomEditor code={propertiesCardTitle} hidePreview />
      </CardBody>
    </Card>
    <Card className="mb-3">
      <CustomCardHeader title="Card with image" light={false} />
      <CardBody className="bg-light">
        <CustomEditor code={cardWithImageCode} scope={{ generic3 }} language="jsx" />
      </CardBody>
    </Card>
    <Card className="mb-3">
      <CustomCardHeader title="Notification" light={false} />
      <CardBody className="bg-light">
        <Notification
          avatar={{
            src: team1,
    ...
    <Card className="mb-3">
      ...
      <CardBody className="bg-light">
        <CustomEditor code={backgroundCode} scope={{ generic3 }} language="jsx" />
      </CardBody>
    </Card>
    <Card className="mb-3">
      <CustomCardHeader title="Cards Groups" light={false} />
      <CardBody className="bg-light">
        <CustomEditor code={cardGroupsCode} scope={{ generic10, generic11, generic12 }} />
      </CardBody>
    </Card>
    <Card className="mb-3">
      <CustomCardHeader title="Cards Deck" light={false} />
      <CardBody className="bg-light">
        <CustomEditor code={cardDeckCode} scope={{ generic6, generic7, generic8 }} />
      </CardBody>
    </Card>
    <Card>
      <CustomCardHeader title="Card styles" light={false} />
      <CardBody className="bg-light">
        <CustomEditor code={cardStyleCode} scope={{ classNames }} language="jsx" />
      </CardBody>
    </Card>
  </Fragment>
);
