...
import defaultModeImg from '../../assets/img/generic/mode-default.jpg';
import darkModeImg from '../../assets/img/generic/mode-dark.jpg';
    ...
    >
      ...
      >
        ...
        <div className="text-center mt-5">
          ...
          <p className="fs--1">Get Mysite now and create beautiful dashboards with hundreds of widgets.</p>
          <Button
            color="primary"
            href="https://themes.getbootstrap.com/product/mysite-admin-dashboard-webapp-template-react/"
          >
            Purchase
          </Button>
        </div>
