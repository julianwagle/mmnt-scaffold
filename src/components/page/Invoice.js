      ...
      <Card className="mb-3">
        <CardBody>
          <Row className="justify-content-between align-items-center">
            ...
            <Col xs="auto">
              <ButtonIcon color="mysite-default" size="sm" icon="arrow-down" className="mr-2 mb-2 mb-sm-0">
                Download (.pdf)
              </ButtonIcon>
              <ButtonIcon color="mysite-default" size="sm" icon="print" className="mr-2 mb-2 mb-sm-0">
                Print
              </ButtonIcon>
              <ButtonIcon color="mysite-success" size="sm" icon="dollar-sign" className="mb-2 mb-sm-0">
                Receive Payment
              </ButtonIcon>
            </Col>
          </Row>
