...
import generic13 from '../../assets/img/generic/13.png';
    ...
    <CardBody>
      <Row className="justify-content-between align-items-center">
        ...
        <Col md="auto" className="mt-4 mt-md-0">
          <ButtonIcon color="mysite-default" size="sm" className="mr-2" icon="heart" iconClassName="text-danger">
            235
          </ButtonIcon>
          <ButtonIcon color="mysite-default" size="sm" className="mr-2" icon="share-alt">
            Share
          </ButtonIcon>
          <Button color="mysite-primary" size="sm" className="px-4 px-sm-5">
            Register
          </Button>
        </Col>
      </Row>
    ...
    <Fragment>
      ...
      {isIterableArray(events) && (
        <Card className="mb-3 mb-lg-0">
          <CustomCardHeader title="Events you may like" />
