          ...
          <CardHeader>
            <Row>
              <Col>
                ...
                <ButtonIcon color="mysite-default" size="sm" icon="plus" iconClassName="fs--2">
                  Add note
                </ButtonIcon>

                <UncontrolledDropdown className="d-inline-block ml-2">
                  <DropdownToggle color="mysite-default" size="sm">
...
const CustomerDetail = () => {
  ...
  return (
    <Card className="mb-3">
      <CustomCardHeader title="Details">
        <ButtonIcon tag={Link} color="mysite-default" size="sm" icon="pencil-alt" to="#!" iconClassName="fs--2">
          Update details
        </ButtonIcon>
      </CustomCardHeader>
      ...
      <CardFooter className="border-top text-right">
        <ButtonIcon tag={Link} color="mysite-default" size="sm" icon="dollar-sign" to="#!" iconClassName="fs--2">
          Refund
        </ButtonIcon>
        <ButtonIcon
          tag={Link}
          color="mysite-default"
          size="sm"
          icon="check"
          className="ml-2"
          to="#!"
...
const CustomerLogs = () => {
  ...
  return (
    <Card>
      ...
      <CustomCardFooterLink title="View more logs" to="#!" borderTop={false} />
    </Card>
  );
};
