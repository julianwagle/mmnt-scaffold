              ...
              <Row>
                ...
                <Col lg={6} className="pl-lg-5">
                  ...
                  >
                    ...
                    <FormGroup>
                      <CommonInput label="Name:" onChange={value => console.log(value)} />
                    </FormGroup>
                    <FormGroup>
                      <CommonInput label="Email:" onChange={value => console.log(value)} type="email" />
                    </FormGroup>
                    <FormGroup>
                      <CommonInput label="Review:" onChange={value => console.log(value)} type="textarea" rows="2" />
                    </FormGroup>
