      ...
      aside={
        <Fragment>
          <Card>
            ...
            <CustomCardFooterLink title="Show all products" to="/e-commerce/products" borderTop={false} />
          </Card>
        </Fragment>
      }
    >
      <Card className="mb-3">
        <CustomCardHeader title="Add new product" />
        <CardBody>
          <Row className="align-items-end" form tag={Form} onSubmit={handleSubmit}>
            <Col sm={6}>
              <CommonInput className="mb-3" label="Title" value={title} onChange={setTitle} />
            </Col>
            <Col sm={6}>
              <CommonInput
                className="mb-3"
            ...
            <Col xs={12}>
              <CustomDropzone placeholder={dropzonePlaceholder} files={files} onChange={setFiles} preview />
            </Col>
          </Row>
        </CardBody>
      </Card>
      ...
      <Card className="mb-3">
        <CardBody tag={Flex} justify="end">
          <Button color="mysite-danger" size="sm" className="mr-2" onClick={clearState}>
            Reset
          </Button>
          <Button
            color={isDisable ? 'mysite-default' : 'mysite-success'}
            size="sm"
            disabled={isDisable}
