            ...
            <Col lg="9">
              ...
              <ModalMediaContent title="Description" icon="paperclip">
                <p className="text-word-break fs--1">
                  ...
                  <a
                    href="https://prium.github.io/mysite/undefined/default/home/dashboard-alt.html"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    https://prium.github.io/mysite//default/home/dashboard-alt.html
                  </a>
                </p>
              </ModalMediaContent>
              {/* //Attachment */}
              <ModalMediaContent
                ...
                headingContent={
                  <UncontrolledButtonDropdown direction="right">
                    <DropdownToggle caret size="sm" color="mysite-default" className="dropdown-caret-none fs--2">
