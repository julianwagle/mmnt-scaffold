  ...
  return (
    <div className="chat-content-header">
      <Row className="flex-between-center">
        ...
        <Col xs="auto">
          <Button color="mysite-primary" className="mr-2" size="sm" id="call-tooltip">
            <FontAwesomeIcon icon="phone" />
            <UncontrolledTooltip placement="left" target="call-tooltip" innerClassName="fs--1">
              Start a Audio Call
            </UncontrolledTooltip>
          </Button>
          <Button color="mysite-primary" className="mr-2" size="sm" id="video-tooltip">
