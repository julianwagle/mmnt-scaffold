...
import MediaImg1 from '../../../../src/assets/img/chat/1.png';
import MediaImg2 from '../../../../src/assets/img/chat/2.png';
import MediaImg3 from '../../../../src/assets/img/chat/3.png';
import MediaImg4 from '../../../../src/assets/img/chat/4.png';
import MediaImg5 from '../../../../src/assets/img/chat/5.png';
import MediaImg6 from '../../../../src/assets/img/chat/6.png';
        ...
        >
          <Media className="position-relative align-items-center p-3 border-bottom">
            ...
            <Media tag={Flex} body className="ml-2 flex-between-center">
              <h6 className="mb-0">
                <Link to="/social/profile" className="text-decoration-none stretched-link text-700">
                  {user.name}
                </Link>
              </h6>
                      ...
                      return (
                        <Media className="align-items-center py-2 hover-actions-trigger" key={index}>
                          ...
                          <Media body tag={Flex} justify="between" className="ml-2">
                            <div>
                              <h6 className="mb-0">
                                <Link to="/social/profile" className="text-700">
                                  {user.name}
                                </Link>
                              </h6>
