...
const CountUpExample = () => (
  <Fragment>
    ...
    <Card className="mb-3">
      ...
      <CardBody>
        <CustomEditor code={countUpCode} scope={{ CountUp }} language="jsx" />
      </CardBody>
    </Card>
    <Card className="mb-3">
      <CustomCardHeader title="Properties" />
      <CardBody>
        <CustomEditor code={countupPropTypesCode} scope={{ CountUp }} language="jsx" hidePreview />
      </CardBody>
    </Card>
    <Card>
      <CustomCardHeader title="Default Properties" />
      <CardBody>
        <CustomEditor code={countupDefaultPropsCode} scope={{ CountUp }} language="jsx" hidePreview />
      </CardBody>
    </Card>
  </Fragment>
);
