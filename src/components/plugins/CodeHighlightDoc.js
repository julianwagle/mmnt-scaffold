...
const CodeHighlightHTML = `function CodeHightHTMLExample () {
  return (
    <CodeHighlight code={'<!DOCTYPE html><html lang="en" dir="ltr" ><head><meta charset="utf-8" /><link rel="shortcut icon" href="%PUBLIC_URL%/favicon.ico" /><meta name="viewport" content="width=device-width, initial-scale=1" /><meta name="theme-color" content="#2c7be5" /><link rel="manifest" href="%PUBLIC_URL%/manifest.json" /><title>Mysite React | ReactJS Dashboard & WebApp Template</title></head><body><noscript>You need to enable JavaScript to run this app.</noscript><main class="main" id="main"></main></body></html>'} language="html" />
  )
}`;
    ...
    <Fragment>
      ...
      <Row noGutters>
        <Col lg={6} className="pr-lg-2 ">
          <Card>
            <CustomCardHeader title="HTML code highlight example" />
            <CardBody>
              <CustomEditor code={CodeHighlightHTML} scope={{ CodeHighlight }} language="jsx" />
            </CardBody>
          </Card>
          <Card className="mt-3">
            <CustomCardHeader title="Bash code highlight example" />
        ...
        <Col lg={6} className="mt-lg-0 mt-3  pl-lg-2">
          <Card>
            <CustomCardHeader title="jsx code highlight example" />
    ...
    <div className="toggle-icon-wrapper">
      ...
      >
        <span className="navbar-toggle-icon">
          ...
          <Card className="mt-3">
            <CustomCardHeader title="Scss code highlight example" />
