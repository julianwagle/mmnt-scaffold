    ...
    <Fragment>
      ...
      <Card>
        ...
        <CardBody>
          <Row>
            <Col lg={4}>
              <CustomEditor code={LottieCode} scope={{ LottieAnim, animationData }} language="jsx" />
            </Col>
            <Col lg={4}>
              <CustomEditor code={lottieCheckCode} scope={{ LottieAnim, checkData }} language="jsx" />
            </Col>
            <Col lg={4}>
              <CustomEditor code={lottieHeartCode} scope={{ LottieAnim, heartData }} language="jsx" />
            </Col>
          </Row>
        </CardBody>
      </Card>
