...
const Display = () => {
  return (
    <Fragment>
      ...
      />
      <Card className="mb-3">
        <CustomCardHeader title="Notation" light={false} />
      ...
      <Card className="mb-3">
        ...
        <CardBody className="bg-light">
          <CustomEditor code={exampleCode} />
        </CardBody>
      </Card>
      <Card className="mb-3">
        <CustomCardHeader title="Hiding Elements" light={false} />
        <CardBody className="bg-light">
          <p>
      ...
      <Card>
        ...
        <CardBody className="bg-light">
          <CustomEditor code={displayInPrintCode} />
        </CardBody>
      </Card>
    </Fragment>
  );
