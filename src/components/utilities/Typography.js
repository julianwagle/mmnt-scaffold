...
const Typography = () => (
  <Fragment>
    <PageHeader
      title="Typography"
      description="Documentation and examples for Mysite typography, including global settings, headings, body text, lists, and special typographic element."
      className="mb-3"
    />
    <Card className="mb-3">
      <CardHeader>
      ...
      <CardBody className="bg-light">
        <CustomEditor code={fontFamilyCode} />
      </CardBody>
    </Card>
    <Card className="mb-3">
      <CardHeader>
    ...
    <Card className="mb-3">
      ...
      <CardBody className="bg-light">
        <CustomEditor code={paragraphCode} />
      </CardBody>
    </Card>
    <Card className="mb-3">
      <CardHeader>
      ...
      <CardBody className="bg-light">
        <CustomEditor code={leadParagraphCode} />
      </CardBody>
    </Card>
    <Card className="mb-3">
      <CustomCardHeader title="Font Weights" light={false} />
      <CardBody className="bg-light">
        <CustomEditor code={fontWeightCode} />
      </CardBody>
    </Card>
    <Card className="mb-3">
      <CardHeader>
      ...
      <CardBody className="bg-light">
        <CustomEditor code={textColorsCode} />
      </CardBody>
    </Card>
    <Card className="mb-3">
      <CardHeader>
      ...
      <CardBody className="bg-light">
        <CustomEditor code={fontSizeCode} />
      </CardBody>
    </Card>
    <Row noGutters>
      <Col sm={6} className="pr-sm-2 mb-3">
        <Card>
          ...
          <CardBody className="bg-light">
            <CustomEditor code={leftAlignCode} />
          </CardBody>
        </Card>
      </Col>
      <Col sm={6} className="pl-sm-2 mb-3">
        <Card>
          ...
          <CardBody className="bg-light">
            <CustomEditor code={rightAlignCode} />
          </CardBody>
        </Card>
      </Col>
      <Col sm={6} className="pr-sm-2 mb-3">
        <Card>
          ...
          <CardBody className="bg-light">
            <CustomEditor code={centerAlignedCode} />
          </CardBody>
        </Card>
      </Col>
      <Col sm={6} className="pl-sm-2 mb-3">
        <Card>
          ...
          <CardBody className="bg-light">
            <CustomEditor code={justifiedCode} />
          </CardBody>
        </Card>
      </Col>
    </Row>
    <Card className="mb-3">
      <CustomCardHeader title="Transformation" />
      <CardBody>
        <CustomEditor code={tranformationCode} />
      </CardBody>
    </Card>
    <Card className="mb-3">
      <CardHeader>
      ...
      <CardBody className="bg-light">
        <CustomEditor code={inlineStylesCode} />
      </CardBody>
    </Card>
    <Card className="mb-3">
      <CardHeader>
      ...
      <CardBody className="bg-light">
        <CustomEditor code={blockquotesCode} />
      </CardBody>
    </Card>
    <Row noGutters>
      <Col sm={6} className="pr-sm-2 mb-3">
      ...
      <Col sm={6} className="pr-sm-2 mb-3">
        <Card>
          ...
          <CardBody className="bg-light">
            <CustomEditor code={unStyledListCode} />
          </CardBody>
        </Card>
      </Col>
      <Col sm={6} className="pl-sm-2 mb-3">
        <Card>
          ...
          <CardBody className="bg-light">
            <CustomEditor code={checkmarkedCode} />
          </CardBody>
        </Card>
      </Col>
    </Row>
