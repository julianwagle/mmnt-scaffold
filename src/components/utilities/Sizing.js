...
const Sizing = () => (
  <Fragment>
    ...
    <Card className="mb-3">
      <CustomCardHeader title="Width (relative to parent)" light={false} />
      <CardBody className="bg-light">
        <CustomEditor code={sizingWidthCode} />
      </CardBody>
    </Card>
    <Card className="mb-3">
      <CustomCardHeader title="Height (relative to parent)" light={false} />
      <CardBody className="bg-light">
        <CustomEditor code={sizingHeightCode} />
      </CardBody>
    </Card>
    <Card>
      <CardHeader>
