  ...
  <Fragment>
    ...
    <Card className="mb-3">
      ...
      <CardBody className="bg-light">
        <CustomEditor code={flexboxExampleCode} />
      </CardBody>
    </Card>
    <Card className="mb-3">
      <CardHeader>
      ...
      <CardBody className="bg-light">
        <CustomEditor code={flexboxDirectionCode} />
        <p className="mt-3">
        ...
        <CustomEditor code={flexItemCode} />
      </CardBody>
    </Card>
    <Card className="mb-3">
      <CardHeader>
      ...
      <CardBody className="bg-light">
        <CustomEditor code={justifyContentCode} />
      </CardBody>
    </Card>
    <Card className="mb-3">
      <CardHeader>
      ...
      <CardBody className="bg-light">
        <CustomEditor code={flexAlignItemCode} language="jsx" />
      </CardBody>
    </Card>
    <Card className="mb-3">
      <CardHeader>
      ...
      <CardBody className="bg-light">
        <CustomEditor code={alignSelfCode} language="jsx" />
      </CardBody>
    </Card>
    <Card className="mb-3">
      <CardHeader>
      ...
      <CardBody className="bg-light">
        <CustomEditor code={flexFillCode} />
      </CardBody>
    </Card>
    <Card className="mb-3">
      <CardHeader>
      ...
      <CardBody className="bg-light">
        <CustomEditor code={growAndShrinkCode} />
      </CardBody>
    </Card>
    <Card className="mb-3">
      <CardHeader>
      ...
      <CardBody>
        <CustomEditor code={autoMarginCode} />
      </CardBody>
    </Card>
    <Card className="mb-3">
      <CardHeader>
      ...
      <CardBody>
        <CustomEditor code={withAlignItemsCode} language="jsx" />
      </CardBody>
    </Card>
    <Card className="mb-3">
      <CardHeader>
      ...
      <CardBody className="bg-light">
        <CustomEditor code={flexWrapCode} language="jsx" />
      </CardBody>
    </Card>
    <Card className="mb-3">
      <CardHeader>
      ...
      <CardBody className="bg-light">
        <CustomEditor code={flexOrderCode} />
      </CardBody>
    </Card>
    <Card className="mb-3">
      <CardHeader>
      ...
      <CardBody className="bg-light">
        <CustomEditor code={flexAlignContentCode} language="jsx" />
      </CardBody>
    </Card>
  </Fragment>
);
