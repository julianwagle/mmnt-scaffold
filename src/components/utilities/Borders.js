...
const Borders = () => (
  <Fragment>
    ...
    <Row noGutters className="mb-3">
      <Col md={6} className="pr-md-2 mb-3">
        <Card className="h-100">
          <CustomCardHeader title="Additive" light={false} />
          <CardBody className="bg-light border-component">
            <CustomEditor code={additiveBorderCode} />
          </CardBody>
        </Card>
      </Col>
      <Col md={6} className="pl-md-2 mb-3">
        <Card className="h-100">
          <CustomCardHeader title="Subtractive" light={false} />
          <CardBody className="bg-light border-component">
            <CustomEditor code={subtrativeBorderCode} />
          </CardBody>
        </Card>
      </Col>
      <Col md={6} className="pr-md-2">
        <Card className="h-100">
          ...
          <CardBody className="bg-light border-component">
            <CustomEditor code={borderColorCode} />
          </CardBody>
        </Card>
      </Col>
      <Col md={6} className="pl-md-2">
        <Card className="h-100">
          ...
          <CardBody className="bg-light border-component">
            <CustomEditor code={borderRadiusCode} />
          </CardBody>
        </Card>
      </Col>
    </Row>
    <Card className="mb-3">
      ...
      <CardBody className="bg-light border-component">
        <CustomEditor code={borderDashedCode} />
      </CardBody>
    </Card>
    <Card>
      <CardHeader>
      ...
      <CardBody className="bg-light border-component">
        <CustomEditor code={borderWidthWithColorCode} />
      </CardBody>
    </Card>
  </Fragment>
);
