  ...
  return (
    <>
      <WidgetsSectionTitle
        icon="user-friends"
        title="Users & Feed"
        subtitle="You can easily display your profile related content with Mysite's special cards."
        transform="shrink-3"
      />
      <Row noGutters className="my-3">
        <Col lg={6} className="pr-lg-2 mb-3 mb-lg-0">
          <Notifications items={4}>
            <CustomCardFooterLink title="All Notifications" to="pages/notifications" />
          </Notifications>
        </Col>
