  ...
  <Fragment>
    <PageHeader title="Getting Started" className="mb-3">
      <p className="mt-2 mb-0">
        ...
        <a
          href="https://themes.getbootstrap.com/product/mysite-admin-dashboard-webapp-template/"
          target="_blank"
          rel="noopener noreferrer"
        >
          original Mysite theme
        </a>
        . This doc will guide you to understand how <strong>Mysite-React</strong> theme is organized, basics of how to
        customize, and how to compile from the source code if you want.
      </p>
    </PageHeader>

    <Card className="mb-3">
      <CustomCardHeader title="Running in Local environment" />
      <CardBody>
        <p>
        ...
        <ol className="mb-0 pl-card">
          ...
          <li>Open the “mysite-react” directory with your cmd or terminal</li>
          <li>
            Run <code>npm i</code>
            <br />
            This command will download all the necessary dependencies for mysite in the <code>node_modules</code>{' '}
            directory.
          </li>
          <li>
    ...
    <Card className="mb-3">
      <CustomCardHeader title="Creating a Production Build" />
      <CardBody>
        <p>
        ...
        <p>
          You can run <code>node server.js</code> to run the production build locally.
        </p>
      </CardBody>
    </Card>

    <Card className="mb-3">
      <CustomCardHeader title="Compiling SCSS" />
      <CardBody>
        <p>
...
export default { version, navbarBreakPoint, topNavbarBreakpoint, settings };`}
    ...
    <Card className="mb-3">
      <CustomCardHeader title="Contents" />
      <CardBody>
        <p className="mb-0">
