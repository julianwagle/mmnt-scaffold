        ...
        <Row>
          <Col lg={4}>
            ...
            <p className="text-600">
              Mysite enables front end developers to build custom streamlined user interfaces in a matter of hours,
          ...
          <Row className="justify-content-between">
            <Col xs={12} sm="auto">
              <p className="mb-0 text-600">
                Thank you for creating with Mysite <span className="d-none d-sm-inline-block">| </span>
