...
import CustomAccordions from '../components/bootstrap-components/CustomAccordions';
...
const InboxRoutes = ({ match: { url } }) => ( // /email
  <InboxProvider>
    <Switch>
...
const ProductRoutes = ({ match: { url } }) => ( //e-commerce/
  <Switch>
...
const DashboardRoutes = () => (
  <Switch>
    ...
    <Route path="/social/events" exact component={Events} />
    <Route path="/funnel/faq" exact component={Faq} />
    <Route path="/billing/invoice" exact component={Invoice} />
    <Route path="/funnel/invite-people" exact component={InvitePeople} />
    <Route path="/social/notifications" exact component={Notifications} />
    <Route path="/social/people" exact component={People} />
    <Route path="/billing/pricing" exact component={Pricing} />
    <Route path="/billing/pricing-alt" exact component={PricingAlt} />
    <Route path="/social/profile" exact component={Profile} />
    <Route path="/social/settings" exact component={Settings} />
    <Route path="/starter" exact component={Starter} />
    <Route path="/test" exact component={Test} />
    {/*chat*/}
    <Route path="/social/chat" exact component={Chat} />
    {/*calendar*/}
    ...
    <Route path="/components/accordions" exact component={CustomAccordions} />
